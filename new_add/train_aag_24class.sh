#!/bin/bash
# Mask2Former AAG 24-class instance segmentation training script.
...
CONFIG="${MASK2FORMER_DIR}/configs/dataset_aag_24class/Base-AAG-24Class-InstanceSegmentation.yaml"
PRETRAIN_WEIGHTS="${PROJECT_DIR}/pretrained/maskformer2_R50_coco_instance.pkl"
NUM_GPUS=1
OUTPUT_DIR="${PROJECT_DIR}/temp_data/aag_24class_output"
IMS_PER_BATCH=2
BASE_LR=0.0001
MAX_ITER=10000
...
echo "=========================================="
echo "  Mask2Former AAG 24-class instance training"
echo "  Config: ${CONFIG}"
