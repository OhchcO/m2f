...
DATASET_DIR="${DATASET_DIR:-${PROJECT_DIR}/temp_data/MFRInstSegM2F_2100}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/temp_data/mfr_multiview_MFRInstSegM2F_2100_bs1_512_output}"
